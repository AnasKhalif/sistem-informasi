    	...
    	$jumlahSks = 0;
    	 foreach($krs_data as $krs) : ?>
    		 ...
    		 <tr>
    			...
    			<td width="20px"><?php echo anchor('administrator/krs/delete/'.$krs->id_krs,'<div class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></div>') ?></td>
    		 </tr>
    	<?php endforeach; ?>
    		 <tr>
    		 	<td colspan="3" align="right"><strong>Jumlah SKS</strong></td>
    		 	<td colspan="3"><?php echo $jumlahSks ?></td>
    		 </tr>
    </table>
